...
function ProductoCardC({producto}) {
    ...
    return (
        <div className="flex justify-center bg-white rounded-xl shadow-xl w-full m-4 sm:w-1/2 md:w-48 md:h-96">
            <div className="px-2 py-4 sm:p-6 sm:pb-4">
                    ...
                    <img src={base+producto.imagen} alt={producto.nombre} width={100} height={100} className="object-cover"/>     
                    </div>
                    <a href='https://api.whatsapp.com/send?phone=522224568189&text=Hola,%20me%20puede%20cotizar%20esto%20' target="_blank">
